...
root_agent = Agent(
    ...
    model=AGENT_MODEL, 
    description="Generate a 300-character Hindi story from a user-provided idea and convert it to speech.",
    instruction=(
        "You are a creative storytelling agent.\n"
        "Given an idea from the user, craft a concise and engaging story in Hindi exactly 300 characters long.\n"
